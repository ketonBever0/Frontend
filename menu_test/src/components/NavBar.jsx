...
function NavBar() {
    ...
    return (
        <div>
                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="block md:hidden">
                                <button onClick={() => setDrawerOpen(prev => !prev)} className="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75 dark:bg-gray-800 dark:text-white dark:hover:text-white/75">
            ...
            <div onClick={() => { setDrawerOpen(false); console.log('a') }} className={`min-h-screen bg-black/50 left-0 top-0 md:hidden ${!drawerOpen && 'hidden'}`}>
                <div onClick={(e) => e.stopPropagation()} className={`min-h-screen fixed right-0 menu bg-base-100 w-56 md:hidden ${!drawerOpen && 'hidden'}`}>
                <ul className={``}>
                    <li><a>Item 1</a></li>
                    <li><a>Item 2</a></li>
                    <li><a>Item 3</a></li>
